...
from flask_jwt_extended import get_jwt_identity, JWTManager, jwt_required, create_access_token, get_jwt_identity, set_access_cookies, set_refresh_cookies, unset_jwt_cookies
...
def update_password():
    ...
    flash('Successful updation of password. You will directed to logout, after which you should login with your new password.')
